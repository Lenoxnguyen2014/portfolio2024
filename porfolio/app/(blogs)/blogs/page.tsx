...
const MyBlogs = async () => {
  ...
  return (
        <main className="h-screen grid grid-cols-2 gap-4 m-32" id="blogs">
        {blogs.items.map((singlePost) => {
          ...
          return (
            <div key={slug} className="block w-full/2 max-w xl:p-2 p-4 sm:m-10 rounded-lg shadow hover:bg-cyan-700 bg-cyan-900 text-white" id="blogs">
