        ...
        <div className="mt-24 flex items-center flex-col w-full h-auto ">
            ...
            <div className="mt-24 grid grid-cols-2 gap-2 max-md:grid-cols-1">
                {sortedProcessList.map((item, key) => {
                    if (item.step %2 == 0) {
                        return(
                            <div className="w-[500px] mt-[24rem] ml-[-64px] py-8 text-primary max-sm:w-96 max-sm:block " key={key}>
                        ...
                        return(
                            <div className="w-[500px] h-64 py-8 mr-16 text-primary max-sm:w-96 max-sm:block" key={key}>
